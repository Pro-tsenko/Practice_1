...
public class PackedBuilder {
    ...
    public byte[] encode(Command command) {
        try {
            ...
            byte[] message = ByteBuffer.allocate(4 + 4 + command.getCommandBody().length)
                    .put(objectMapper.writeValueAsBytes(command.getCommandId()))
                    .putInt(command.getUserId())
    ...
    public Command decode(byte[] packet) {
        try {
            ...
            System.out.println("clientid: " + clientId + "packet: " + packetId);
    ...
    public static void main(String[] args) {
        Command command = new Command(CommandType.CREATE_PRODUCT, 1, new byte[]{ 1, 2, 3 });
